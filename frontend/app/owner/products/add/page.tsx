...
export default function AddProductPage() {
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    try {
      ...
      // If user uploaded a local file from device:
      ...
      toast.dismiss("upload-toast");
      setError(err?.message ?? "Failed to create product. Please check fields and try again.");
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-[#2A2B30]">
        <div>
          ...
          <p className="text-xs text-[#A1A1AA] mt-1">
            Create and publish a new item to your merchant catalog with Cloudinary asset storage.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-5 rounded-3xl bg-[#1A1B1E] border border-[#2A2B30] p-6 shadow-sm">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#A1A1AA] mt-1.5">
                Unique identifier for inventory tracking. Generated automatically or entered manually.
              </p>
            </div>
          ...
          <div className="space-y-5 rounded-3xl bg-[#1A1B1E] border border-[#2A2B30] p-6 shadow-sm flex flex-col justify-between">
              ...
              {imageInputMode === "url" && (
                <div className="space-y-3">
                  ...
                  <p className="text-[11px] text-[#A1A1AA]">
                    Remote images are validated and securely imported to Cloudinary CDN upon creation.
                  </p>
                </div>
              )}
              ...
              {(previewUrl || imageUrl) && (
                <div className="space-y-2 pt-2">
                  ...
                  <div className="relative h-48 w-full rounded-2xl bg-black/40 border border-[#2A2B30] overflow-hidden flex items-center justify-center">
                    <img
                      src={previewUrl || imageUrl || DEFAULT_IMAGE}
                      alt="Product preview"
                    ...
                    />
                    <div className="absolute bottom-2 left-2 right-2 flex items-center justify-between bg-black/70 backdrop-blur-sm px-2.5 py-1 rounded-xl text-[10px] text-white">
                      <span className="truncate max-w-[200px]">
                        {selectedFile ? selectedFile.name : "Remote Image"}
                      </span>
            ...
            <div className="flex gap-3 pt-4 border-t border-[#2A2B30]">
              ...
              >
                ...
                <span>{loading ? "Saving Product..." : "Create Product"}</span>
              </button>
