    ...
    >
      ...
      >
        ...
        {routes.map((route, index) => {
          ...
          if (!isSelected) return null; // Only show selected route if multiple, to avoid overlap mess in simple Leaflet polyline
          return null;
        })}
      ...
      <button
        ...
        className="absolute top-3 right-3 z-[1000] p-2 bg-white rounded-xl shadow-md text-slate-800 hover:bg-slate-50 transition-colors border border-slate-200"
      ...
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center bg-black/20 z-[2000] backdrop-blur-sm rounded-xl">
